...
- (instancetype)init
{
    ...
    if(self)
    {
        ...
        self.rtmpUrl = @"rtmp://192.168.2.49/live/2005";
    }
    return self;
}
...
- (BOOL)startRtmpConnect
{
    ...
    RTMP_Init(self->rtmp);
   // int err = RTMP_SetupURL(self->rtmp, (char*)[_rtmpUrl UTF8String]);
    const char * a =[self.rtmpUrl UTF8String];
    int err = RTMP_SetupURL(self->rtmp, (char *)a);
